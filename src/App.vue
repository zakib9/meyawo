...
<template>
    <div :class="['flex gap-4 justify-between px-80 py-5 text-xl fixed m-auto w-full top-0 left-0 transition-colors duration-300', { 'bg-white shadow-md text-primary': scrolled, 'bg-transparent text-white': !scrolled }]"
      >
